...
const uz: typeof ru = {
  ...
  admin: {
    ...
    banner: "Banner",
    bannerHint: "Bosh sahifadagi karuseldagi har bir slaydni tahrirlash yoki oʻchirish mumkin — barcha slaydlar bir xil oʻlchamda. Sarlavha va matn ixtiyoriy: boʻsh qoldirilsa, rasm butun slaydni egallaydi.",
    bannerImageLabel: "Rasm",
    bannerImageRequired: "Slayd uchun rasm yuklang.",

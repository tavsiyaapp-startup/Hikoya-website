...
const uz: typeof ru = {
  ...
  reader: {
    ...
    gateBody:
      "Birinchi bob barcha uchun ochiq. Hikoyani davom ettirish, progressni saqlash, Bookmark qoʻyish va izoh yozish uchun akkaunt kerak.",
  ...
  create: {
    ...
    genreLabel: "Janr",
    addGenre: "+ Janr qoʻshish",
    genreInputPlaceholder: "Janr nomi",
    addGenreConfirm: "Qoʻshish",
    relationshipLabel: "Munosabat turi",
    relationshipHint: "(ixtiyoriy)",
    progressStatusLabel: "Asar holati",
    tagsLabel: "Teglar",
  ...
  manage: {
    ...
    hiddenReasonLabel: "Administratsiya tomonidan yashirish sababi",
  ...
  profile: {
    ...
    passwordWeak: "Parol juda oddiy. Boshqasini sinab koʻring — masalan, raqamlar bilan.",
    ...
    passwordChangeError: "Parolni yangilab boʻlmadi. Qaytadan urinib koʻring.",
    resetPageTitle: "Yangi parol",
    resetPageBody: "Akkauntga kirish uchun yangi parol oʻylab toping.",
    resetLinkInvalid: "Havola yaroqsiz yoki muddati oʻtgan. Profil sozlamalaridan yangisini soʻrang.",
    backToProfile: "Profilga oʻtish",
  ...
  author: {
    ...
    totalLikes: "layk",
    subscribe: "Obuna boʻlish",
    verified: "Verifikatsiyadan oʻtgan",
    tabStories: "Hikoyalar",
    tabCollections: "Tavsiya etilgan tanlanmalar",
    tabMyRequests: "Mening soʻrovlarim",
    noStoriesYet: "Bu yerda hozircha chop etilgan hikoyalar yoʻq.",
    noCollectionsYet: "Bu muallifning hikoyalari kirgan tanlanmalar hali yoʻq.",
  },
  library: {
    ...
    noBookmarksYet: "Bookmark hozircha yoʻq.",
  ...
  notifications: {
    ...
    adminMessage: "Administratsiya qoʻllab-quvvatlash chatida javob berdi",
  },
  chat: {
  ...
  onboarding: {
    ...
    nameTitle: "Profilni sozlang",
    nameBody: "Ism, rasm va kirish uchun parol. Buni hammasini keyinroq profil sozlamalarida oʻzgartirish mumkin.",
    nameLabel: "Koʻrsatiladigan ism",
    passwordLabel: "Kirish uchun parol",
    passwordHint: "Keyinchalik email va parol orqali, pochtaga havola yoki Google-siz kirish uchun kerak boʻladi. Kamida 6 ta belgi.",
    passwordTooShort: "Parol kamida 6 ta belgidan iborat boʻlishi kerak.",
  ...
  admin: {
    ...
    collections: "Tanlanmalar",
    featured: "Top",
    featuredHint: "Hikoyalarni kun/hafta/oy topiga belgilang — ular bosh sahifada alohida blok sifatida chiqadi va qidiruvda birinchi boʻlib koʻrinadi.",
    banner: "Banner",
    ...
    bannerTitleRu: "Sarlavha (RU)",
    bannerTitleUz: "Sarlavha (UZ)",
    bannerBodyRu: "Matn (RU)",
    bannerBodyUz: "Matn (UZ)",
    bannerCtaLabelRu: "Tugma matni (RU)",
    bannerCtaLabelUz: "Tugma matni (UZ)",
    bannerCtaUrl: "Tugma havolasi",
    bannerOptional: "(ixtiyoriy)",
    bannerAddSlide: "Slayd qoʻshish",
    bannerCurrentSlides: "Joriy slaydlar",
    bannerNoSlidesYet: "Hozircha qoʻshimcha slaydlar yoʻq.",
    bannerConfirmDelete: "Slaydni oʻchirasizmi? Bu amalni bekor qilib boʻlmaydi.",
    announcements: "Eʼlonlar",
    announcementsHint: "Bosh sahifada banner yonidagi kichik kartochkalar — eng yangi 2 tasi koʻrsatiladi. Rasm va matn ixtiyoriy, lekin kamida bittasi boʻlishi kerak.",
    announcementImageLabel: "Rasm",
    announcementTextRu: "Matn (RU)",
    announcementTextUz: "Matn (UZ)",
    announcementAdd: "Eʼlon qoʻshish",
    announcementsCurrent: "Joriy eʼlonlar",
    announcementsNoneYet: "Hozircha eʼlonlar yoʻq.",
    announcementImageOnly: "Matnsiz (faqat rasm)",
    announcementRequired: "Rasm yoki matn qoʻshing.",
    announcementConfirmDelete: "Eʼlonni oʻchirasizmi? Bu amalni bekor qilib boʻlmaydi.",
    settings: "Sozlamalar",
    searchUsers: "Ism, email yoki ID boʻyicha qidiruv",
    searchStories: "Hikoya nomi boʻyicha qidiruv",
    topTierDay: "Kun",
    topTierWeek: "Hafta",
    topTierMonth: "Oy",
    allStories: "Barcha hikoyalar",
    allUsers: "Barcha foydalanuvchilar",
    allActivity: "Barcha harakatlar",
    recentActivity: "Soʻnggi harakatlar",
    activityPublishedStory: "yangi hikoya chop etdi",
    activityNewComment: "hikoyaga izoh qoldirdi",
    activityNewUser: "platformada roʻyxatdan oʻtdi",
    noActivityYet: "Hozircha hech qanday harakat yoʻq.",
    filterFrom: "Dan",
    filterTo: "Gacha",
    filterApply: "Koʻrsatish",
    filterReset: "Bekor qilish",
    activityStatsNewUsers: "Yangi roʻyxatdan oʻtishlar",
    activityStatsPublishedChapters: "Chop etilgan boblar",
    activityStatsNewComments: "Izohlar",
    check: "Tekshirish",
    delete: "Oʻchirish",
    ...
    addModeratorTitle: "Moderatorlar",
    addModeratorBody: "Yangi moderator uchun admin-panelga kirish yarating — unda sizdagi barcha imkoniyatlar boʻladi, faqat yangi moderator qoʻshish bundan mustasno.",
    moderatorEmailLabel: "Email (kirish uchun login)",
    moderatorPasswordLabel: "Parol",
    moderatorDisplayNameLabel: "Ism",
    moderatorAdd: "Moderator qoʻshish",
    moderatorAdded: "Moderator qoʻshildi. U /admin-login sahifasida shu email va parol bilan kira oladi.",
    moderatorErrorMissingFields: "Email, parol va ismni toʻldiring.",
    moderatorErrorShortPassword: "Parol kamida 6 ta belgidan iborat boʻlishi kerak.",
    moderatorErrorGeneric: "Moderator yaratib boʻlmadi. Qaytadan urinib koʻring.",
    moderatorErrorEmailExists: "Bu email allaqachon mavjud akkauntga tegishli. Uni moderator qilish uchun «Foydalanuvchilar» sahifasida rolini oʻzgartiring, bu yerda yangi kirish yaratmang.",
    ...
    sortByFollowers: "Obunachilar boʻyicha",
    sortByStories: "Hikoyalar soni boʻyicha",
    colOwnerType: "Egasi",
    colVerified: "Verifikatsiya",
    block: "Bloklash",
    unblock: "Blokdan chiqarish",
    manageBadges: "Beljiklar",
    saveBadges: "Beljiklarni saqlash",
    noBadgesAvailable: "Hozircha birorta ham beljik yoʻq.",
    writeMessage: "Yozish",
    chats: "Chatlar",
    chatsTitle: "Foydalanuvchilar bilan chatlar",
    noChatsYet: "Hozircha birorta ham chat yoʻq.",
    comments: "Izohlar",
    noCommentsYet: "Hozircha izohlar yoʻq.",
    colChapter: "Bob",
  ...
  auth: {
    ...
    loginPageBody: "Email va parol orqali kiring.",
    noAccount: "Akkountingiz yoʻqmi?",
    passwordPlaceholder: "Parol",
    passwordLoginError: "Email yoki parol notoʻgʻri.",
    showPassword: "Parolni koʻrsatish",
    hidePassword: "Parolni yashirish",
    forgotLoginPassword: "Email yoki parolni unutdingizmi?",
    fallbackLoginBody: "Email-havola yoki Google orqali kiring — parolni eslamasangiz ham boʻladi.",
    backToPasswordLogin: "← Parol orqali kirish",
    setPasswordTitle: "Kirish uchun parol oʻrnating",
    setPasswordBody: "Keyingi safar pochta havolasi yoki Google-siz, toʻgʻridan-toʻgʻri email va parol orqali kirish uchun.",
    setPasswordCta: "Saqlash va saytga oʻtish",
    setPasswordFailed: "Parolni saqlab boʻlmadi. Qaytadan urinib koʻring.",
  },
  meta: {

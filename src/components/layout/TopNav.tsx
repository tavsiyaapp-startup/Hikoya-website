...
export function TopNav({ user }: { user: CurrentUser | null }) {
  ...
  return (
    <nav className="sticky top-[64px] z-10 border-b border-border bg-card/92 backdrop-blur-md sm:top-[76px]">
      <div className="flex gap-1 overflow-x-auto px-3 py-2 sm:px-5 lg:px-8">
        {items.map((item) => {

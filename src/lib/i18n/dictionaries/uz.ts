...
const uz: typeof ru = {
  ...
  onboarding: {
    ...
    nameBody: "Ismni pochtangizdan oldik — shundayligicha qoldiring yoki oʻzgartiring. Buni keyinroq profilda ham oʻzgartirish mumkin.",
    nameLabel: "Koʻrsatiladigan ism",
    passwordLabel: "Parol (ixtiyoriy)",
    passwordHint: "Keyinchalik email va parol orqali, pochtaga havolasiz kirish imkonini beradi. Kamida 6 ta belgi.",
    passwordTooShort: "Parol kamida 6 ta belgidan iborat boʻlishi kerak.",
  ...
  auth: {
    ...
    passwordLoginToggle: "Parol orqali kirish",
    magicLinkToggle: "Pochta havolasi orqali kirish",
